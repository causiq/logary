...
of this License; and 1. You must cause any modified files to carry prominent
notices stating that You changed the files; and 1. You must retain, in the
...
those notices that do not pertain to any part of the Derivative Works; and 1. If
the Work includes a "NOTICE" text file as part of its distribution, then any
