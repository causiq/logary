...
export default function TargetsPage() {
  return (
    <DocPage name="all-target" title="Targets / Sinks" colour="pink">
      ...
      <DocSection title='File target' id='file'>
        <p>
      ...
      <DocSection title='Stackdriver target' id='stackdriver'>
        <p>
      ...
      <DocSection title='Jaeger tracing target' id='jaeger'>
        <ul>
          <br></br>
      ...
      <DocSection title='Azure AppInsights target' id='azure-appinsights'>
        <p>
      ...
      <DocSection title='Commercial targets' id='commercial-targets'>
