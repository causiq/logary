  ...
  return (
    <DocPage name="rutta" title="Logary Rutta" faIcon={faSatelliteDish} colour="bluee" readingMinutes={2} toc={toc}>
      ...
      <DocSection {...toc[0]}>
        ...
        <p>Rutta is GPLv3 licensed (or alternatively commercially licensed). It's a packaging of Logary as a service, that you can run, either as a sidecar container or as a log router in the middle of things.</p>
      ...
      <DocSection {...toc[1]}>
        ...
        <p>
          <code>helm install https://github.com/logary/logary/tree/master/src/services/rutta-helm-chart --name rutta</code>
        </p>
      </DocSection>
      <DocSection {...toc[2]}>
