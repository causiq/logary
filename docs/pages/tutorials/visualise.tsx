...
export default function Tutorials() {
  ...
  [
    ...
    { id: "ril", title: "RuntimeInfo and internal logging", ref: useRef(null) } ,
    { id: "wwnf", title: "When to write a new function?", ref: useRef(null) } ,
    { id: "hton", title: "How to open namespaces?", ref: useRef(null) } ,
    { id: "tsj", title: "To start the job or not?", ref: useRef(null) } ,
    { id: "wnt", title: "Writing a new target", ref: useRef(null) } ,
  ]
  ...
  return (
    <DocPage name="js-quickstart" title="Tutorials" faIcon={faFileChartLine} colour="primary" readingMinutes={3} toc={toc}>
      ...
      <DocSection {...toc[2]}>
        <h2 className="section-title">Namespace guidelines – <span className="_code"> Logary.Internals </span>or not</h2>
        <p></p>
      ...
      <DocSection {...toc[3]}>
        <h2 className="section-title">RuntimeInfo and internal logging</h2>
        <p></p>
      ...
      <DocSection {...toc[4]}>
        <h2 className="section-title">When to write a new function?</h2>
        <p></p>
      ...
      <DocSection {...toc[5]}>
        <h2 className="section-title">How to open namespaces?</h2>
        <p></p>
